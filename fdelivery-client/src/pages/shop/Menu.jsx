...
const Menu = () => {
    ...
    useEffect(() => {
        ...
        // sorting based alphabetically and by price
  ...
  return (
    <div>
        ...
        <div className='section-container bg-base-100'>
            <div className='text-center py-48 flex flex-col justify-center items-center gap-8'>
            ...
            <div className='flex flex-col md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8'>
                ...
                <div className='flex justify-end mb-4 rounded-sm'>
                    ...
                    <select name='sort' id='sort' onChange={(e) => handleSortChange(e.target.value)} value={sortOption}
                        className='bg-black text-white px-2 pt-1 rounded-sm'>
