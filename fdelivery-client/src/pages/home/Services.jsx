...
const serviceList = [
    ...
    { id: 4, title:'Gift Cards', description:'Give the gift of exceptional dining with Cheffeur Gift Cards', image: '/images/home/services/icon4.png'},
]
const Services = () => {
  return (
                ...
                <div className='grid sm:grid-cols-2 grid-cols-1 gap-8 items-center'>
                    {
                        serviceList.map((service) => (
                            ...
                            hover:border-indigo-600 transition-all duration-200 hover:border'>
                                ...
                                <p className='text-[#988095]'>{service.description}</p>
                            </div>
                        ))
                    }
                </div>
